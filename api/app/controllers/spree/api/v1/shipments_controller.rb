    ...
    module V1
      class ShipmentsController < Spree::Api::BaseController
        ...
        def create
          ...
          @line_item = Spree::AddItemToCart.new.call(order: @order,
                                                     variant: variant,
                                                     quantity: quantity,
        ...
        def add
          ...
          Spree::AddItemToCart.new.call(order: @shipment.order,
                                        variant: variant,
                                        quantity: quantity,
        ...
        def remove
          ...
          Spree::RemoveItemFromCart.new.call(order: @shipment.order, variant: variant, quantity: quantity, options: { shipment: @shipment })
