  ...
  class Shipment < Spree::Base
    ...
    def transfer_to_location(variant, quantity, stock_location)
      ...
      transaction do
        ...
        Spree::Cart::RemoveItem.call(order: order, variant: variant, quantity: quantity, options: { shipment: self })
        Spree::Cart::AddItem.call(order: order, variant: variant, quantity: quantity, options: { shipment: new_shipment })
    ...
    def transfer_to_shipment(variant, quantity, shipment_to_transfer_to)
      ...
      transaction do
        Spree::Cart::RemoveItem.call(order: order, variant: variant, quantity: final_quantity, options: { shipment: self })
        Spree::Cart::AddItem.call(order: order, variant: variant, quantity: final_quantity, options: { shipment: shipment_to_transfer_to }).value
        order.update_with_updater!
