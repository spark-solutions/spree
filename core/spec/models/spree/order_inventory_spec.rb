  ...
  context '#add_to_shipment' do
    ...
    context 'store doesnt track inventory' do
      ...
      it 'creates only on hand inventory units' do
        ...
        line_item = Spree::AddItemToCart.new.call(order: order, variant: variant, options: { shipment: shipment }).value
    ...
    context 'variant doesnt track inventory' do
      ...
      it 'creates only on hand inventory units' do
        ...
        line_item = Spree::AddItemToCart.new.call(order: order, variant: variant).value
