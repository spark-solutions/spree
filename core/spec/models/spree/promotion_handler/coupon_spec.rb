        ...
        context 'with a per-item adjustment action' do
          ...
          context 'coexists with a non coupon code promo' do
            ...
            before do
              ...
              AddItemToCart.new.call(order: order, variant: create(:variant))
            end
          ...
          context 'and the product price is less than promo discount' do
            before do
              3.times do |_i|
                ...
                AddItemToCart.new.call(order: @order, variant: taxable.master)
              end
            end
          ...
          context 'and the product price is greater than promo discount' do
            before do
              3.times do |_i|
                ...
                AddItemToCart.new.call(order: @order, variant: taxable.master, quantity: 2)
              end
            end
            it 'successfully applies the promo' do
              # 3 * (22 + 2.2)
