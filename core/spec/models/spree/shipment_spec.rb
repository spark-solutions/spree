...
describe Spree::Shipment, type: :model do
  ...
  context 'manifest' do
    ...
    let!(:line_item) { Spree::AddItemToCart.new.call(order: order, variant: variant).value }
  ...
  context '#cancel' do
    ...
    context 'with backordered inventory units' do
      ...
      before do
        Spree::AddItemToCart.new.call(order: order, variant: variant)
        order.create_proposed_shipments

        Spree::AddItemToCart.new.call(order: other_order, variant: variant)
